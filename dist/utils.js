...
const ALLOWED_METHOD_HASH = starknet_1.typedData.getTypeHash(typedDataConsts_1.GS_SESSION_REQUEST_TYPES, "AllowedMethod", starknet_1.TypedDataRevision.ACTIVE);
const ALLOWED_METHOD_HASH_V2 = starknet_1.typedData.getTypeHash(typedDataConstsV2_1.GS_SESSION_REQUEST_TYPES_V2, "AllowedMethod", starknet_1.TypedDataRevision.ACTIVE);
const CALLDATA_VALIDATION_HASH = starknet_1.typedData.getTypeHash(typedDataConstsV2_1.GS_SESSION_REQUEST_TYPES_V2, "CalldataValidation", starknet_1.TypedDataRevision.ACTIVE);
const GAS_SPONSORED_SESSION_EXECUTION_HASH_V2 = starknet_1.typedData.getTypeHash(typedDataConstsV2_1.GS_SESSION_REQUEST_TYPES_V2, "GasSponsoredSessionExecution", starknet_1.TypedDataRevision.ACTIVE);
const getRequestedMethodGuid = (requestedMethod) => starknet_1.hash.computePoseidonHashOnElements([
    ...
    (0, exports.numberToHex)(requestedMethod.selector ??
...
const getAllowedMethodHintsCalldata = (requestedMethods, calls) => {
    return [
        calls.length,
        ...calls.map(call => requestedMethods.findIndex(rm => (0, exports.numberToHex)(rm.contractAddress) ===
            (0, exports.numberToHex)(call.contractAddress) &&
            (rm.entrypoint
                ? rm.entrypoint === call.entrypoint
                : (0, exports.numberToHex)(rm.selector) ===
                    (0, exports.numberToHex)(starknet_1.selector.getSelectorFromName(call.entrypoint))) &&
